...
<?php
   ...
   <?php      if(!isset($_GET['id']))
				{
					?>
		<script src="https://maps.googleapis.com/maps/api/js?key=key_here&libraries=drawing,places&v=3.45.8"></script> 			
		<script>
...
function auto_grow() {
        ...
        google.maps.event.addDomListener(window, 'load', initialize);
				...
				<?php } else { ?>
		<script src="https://maps.googleapis.com/maps/api/js?v=3.45.8&key=key_here&libraries=drawing,places"></script>
	<script>
    auto_grow();
    function auto_grow() {
        let element = document.getElementById("coordinates");
